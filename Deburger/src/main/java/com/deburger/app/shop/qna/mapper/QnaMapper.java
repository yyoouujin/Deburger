...
public interface QnaMapper {
	...
	//QnA상세 조회(가맹점)
	public QnaVO qnaShopInfoShop(QnaVO qnaVO);
	
	//가맹점에서 QnA수정(접수 상태일때 활성화)
	public int qnaShopUpdate(QnaVO qnaVO);
	
	//가맹점에서 QnA삭제(접수 상태일때 활성화)
	public int qnaShopDelete(QnaVO qnaVO);
	...
	//QnA 댓글 수정
	public int qnaCommertUpdate(QnaVO qnaVO);
